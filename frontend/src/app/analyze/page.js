        ...
        {mode === "camera" && !preview && (
          <div className="mb-4">
            ...
            <button
              ...
              className="w-full mt-4 bg-neutral-900 text-white py-4 rounded-2xl font-medium hover:bg-neutral-700 transition-colors"
            >
              Capture
            </button>
          </div>
